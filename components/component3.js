...
export default {
    ...
    setup() {
        ...
        onMounted(() => {            
            fetch('https://api.tvmaze.com/search/shows?q=shortland%20street')
    ...
    <div>
        ...
        <table>
            <tr>
                <th><a href="javascript:void(0);" v-on:click="sortByColumn = 'item.show.name'">Name</a></th>
                <th><a href="javascript:void(0);" v-on:click="sortByColumn = 'item.show.premiered'">premiered</a></th>
                <th><a href="javascript:void(0);" v-on:click="sortByColumn = 'item.show.summary'">summary</a></th>
            </tr>        
